      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
          <div style="background-color: #171717; padding: 20px; text-align: center;">
            <h2 style="color: #191970; margin: 0; font-size: 24px; font-weight: bold;">New Lead / Contact Request</h2>
          </div>
          <div style="padding: 30px; background-color: #ffffff;">
            ...
            <div style="background-color: #F9FAFB; border-left: 4px solid #191970; padding: 15px; border-radius: 4px;">
              <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #1F2937; white-space: pre-wrap;">${message}</p>
            </div>
          </div>
          <div style="background-color: #F3F4F6; padding: 15px; text-align: center; font-size: 12px; color: #9CA3AF;">
            This email was automatically generated from the Finzavio platform.
          </div>
        </div>
      `,
    };
